(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".start__slider")) new core(".start__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            pagination: {
                el: ".start__slider .swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".start__slider .swiper-button-prev",
                nextEl: ".start__slider .swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".costumers__slider")) new core(".costumers__slider", {
            ...
            loop: true,
            pagination: {
                el: ".costumers__slider .swiper-pagination",
                clickable: true
            },
            on: {}
        });
        ...
        let observer = new IntersectionObserver(((entries, observer) => {
            entries.forEach((entry => {
                if (entry.isIntersecting) {
                    ...
                    if (digitsCountersItems && digitsCountersItems.length) digitsCountersInit(digitsCountersItems);
                    observer.unobserve(targetElement);
                }
            }));
        }), options);
        let sections = document.querySelectorAll(".page__achievments");
